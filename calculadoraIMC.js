...
function calcular(event){
    ...
    if (imc[0] < 17) {
        ...
        resultado[0].innerHTML = "<br/>"+nome[0]+" seu resultado foi: "+imc[0].toFixed(2)+"<br/> Cuidado você está com sobrepeso."
    } else if (imc[0] > 30 && imc[0] <= 34.99){
        resultado[0].innerHTML = "<br/> Seu resultado foi: "+imc[0].toFixed(2)+"<br/> CUIDADO, obesidade grau I!"
    ...
    if (imc[1] < 17) {
        ...
        resultado[1].innerHTML = "<br/>"+nome[1]+" seu resultado foi: "+imc[1].toFixed(2)+"<br/> Cuidado você está com sobrepeso."
    } else if (imc[1] > 31 && imc[1] <= 34.99){
        resultado[1].innerHTML = "<br/> Seu resultado foi: "+imc[1].toFixed(2)+"<br/> CUIDADO, obesidade grau I!"
    ...
    if (imc[2] < 17) {
        ...
        resultado[2].innerHTML = "<br/>"+nome[2]+" seu resultado foi: "+imc[2].toFixed(2)+"<br/> Cuidado você está com sobrepeso."
    } else if (imc[2] > 31 && imc[2] <= 34.99){
        resultado[2].innerHTML = "<br/> Seu resultado foi: "+imc[2].toFixed(2)+"<br/> CUIDADO, obesidade grau I!"
